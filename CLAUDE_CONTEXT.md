...
| 🟡 | — | **GitHub Release v1.402/v1.403** | v1.402: Warranty RO type. v1.403: Slack integration (5 triggers + slack-notify Edge Function). github.com/PatriotsRV/rv-dashboard/releases/new — tag `v1.402` and `v1.403` | ⏳ Roland action |
