...
| 🟠 | GH#19 | **Customer Check-In Page** | Front desk RO intake + RAF e-signature. Next session build target (deferred from Session 42/43 — Slack integration took priority). | ⏳ Open |
...
| 🟡 | — | **GitHub Release v1.402/v1.403/v1.404/v1.405** | v1.402: Warranty RO type. v1.403: Slack integration (5 triggers + slack-notify Edge Function). v1.404: GH#23 Morning Manager Report (send-manager-report v1.8). v1.405: GH#24 Shop Operations RO Phase 1. github.com/PatriotsRV/rv-dashboard/releases/new — tag `v1.402`, `v1.403`, `v1.404`, `v1.405` | ⏳ Roland action |
...
| `customer-checkin.html` | **v1.2** (~112 KB) | GH#19 Customer Check-In Page — front desk RO intake + RAF e-signature. **Session 49:** Replaced marble CSS backdrop with fixed full-bleed RV park mountain photo (`checkin-bg.jpg`), boosted vibrance (saturate 1.25, contrast 1.05), light cream overlay (~20% opacity). Commits: 71489b5, 6ac5c07. |
