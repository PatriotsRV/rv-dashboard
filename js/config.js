...
export const STATUS_PROGRESS_MAP = {
    ...
    // [S175] 'Awaiting Approval' retired — split by approval source (all inherit 20).
    'Awaiting Insurance': 20,
    'Awaiting Customer': 20,
    'Awaiting Extended Warranty': 20,
    // [S175] NEW Approved trio — one notch past Awaiting (Roland call S175).
    'Approved Insurance': 25,
    'Approved Customer': 25,
    'Approved Extended Warranty': 25,
    'Awaiting parts': 30,
    'Scheduled': 45,
    'Ready to Work': 50,
    'In progress': 60,
...
export const TRANSLATIONS_ES = {
    ...
    // [S175] 'Awaiting Approval' is now the GROUP label (filter chip + optgroup);
    // the 6 source-specific statuses follow. 'Approved' is the second group label.
    'Awaiting Approval': 'Esperando Aprobación',
    'Approved': 'Aprobado',
    'Awaiting Insurance': 'Esperando Seguro',
    'Awaiting Customer': 'Esperando Cliente',
    'Awaiting Extended Warranty': 'Esperando Garantía Extendida',
    'Approved Insurance': 'Aprobado por Seguro',
    'Approved Customer': 'Aprobado por Cliente',
    'Approved Extended Warranty': 'Aprobado por Garantía Extendida',
    'Insurance': 'Seguro',
    'Customer': 'Cliente',
